...
def is_allowed_torrent_format(torrent_path: str) -> bool:
        """
...
def download_torrent(torrent_path: str, download_dir: str = "/tmp/torrents"):
    """
    ...
    if not is_allowed_torrent_format(torrent_path=torrent_path):
